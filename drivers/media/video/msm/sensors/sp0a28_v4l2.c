...
*/
#define SP0A28_P0_0xd3	0x98
#define SP0A28_P0_0xd4	0x98
#define SP0A28_P0_0xd6	0x90
#define SP0A28_P0_0xd7	0x70

#define SP0A28_P0_0xd8	0x98
#define SP0A28_P0_0xd9	0x98
#define SP0A28_P0_0xda	0x90
#define SP0A28_P0_0xdb	0x70
#endif
...
static struct msm_camera_i2c_reg_conf sp0a28_full_settings[] = {
      ...
      {0x33,0xff},
      {0x35,0x40},
      #if  defined(CONFIG_PROJECT_P865F04) || defined(CONFIG_PROJECT_P825V20)
      {0x31,0x10},//yuxin add
      #else
      {0x31,0x70},
      #endif
