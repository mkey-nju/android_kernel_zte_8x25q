...
///////////////////////////////////////////
      ...
      {0x0010, 0x41},
#if defined (CONFIG_PROJECT_P865G01) || defined(CONFIG_PROJECT_P865F05) || defined( CONFIG_PROJECT_P825V20) 
      {0x0011, 0x03}, //00}, exposure method change
#else
...
static struct msm_camera_i2c_reg_conf hi542_recommend_settings[] ={
#if defined (CONFIG_PROJECT_P865G01) || defined(CONFIG_PROJECT_P865F05) || defined( CONFIG_PROJECT_P825V20) 
      {0x0011, 0x93}, //00}, exposure method change
#else
      {0x0011, 0x90}, //00}, exposure method change  
#endif
	...
	{0x0129,0xAB}, /* man_spec_edof_ctrl_edof_fw_spare_0 Gain x7 */
     ...
     //{0x0116,0x13}, /* man_spec_edof_ctrl_edof_fw_spare_0 Gain x7 */
     //{0x0117,0x39}, /* man_spec_edof_ctrl_edof_fw_spare_0 Gain x7 */
     //{0x0118,0xE0}, /* man_spec_edof_ctrl_edof_fw_spare_0 Gain x7 */
     //30fps
     {0x0115,0x00}, /* man_spec_edof_ctrl_edof_fw_spare_0 Gain x7 */
	{0x0116,0x01}, /* man_spec_edof_ctrl_edof_fw_spare_0 Gain x7 */
	{0x0117,0xD4}, /* man_spec_edof_ctrl_edof_fw_spare_0 Gain x7 */
	{0x0118,0xCD}, /* man_spec_edof_ctrl_edof_fw_spare_0 Gain x7 */
	...
	{0x0013,0x00}, //00}, exposure method change 
			...
			int update_type, int res)
{
	...
	if (update_type == MSM_SENSOR_REG_INIT) {
       ...
       if(otp_read_flag == 1)
       {
            ...
            #if defined (CONFIG_PROJECT_P865G01) || defined (CONFIG_PROJECT_P865F05)
