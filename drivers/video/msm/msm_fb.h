...
typedef enum {
	...
	LCD_PANEL_4P5_OTM9608_QHD_YUSHUN,//zhoufan
	LCD_PANEL_5P0_NT35516_YUSHUN,//wangminrong add 5p0 yushun
	LCD_PANEL_5P0_OTM9608A_YASSY,  
	LCD_PANEL_5P0_OTM9608A_BOE,    //haoweiwei add
	LCD_PANEL_5P0_NT35516_TM,  //zhoufan add
        LCD_PANEL_5P0_OTM9608_HSD_LEAD, 
	LCD_PANEL_5P0_OTM9608A_YASSY_6G, //lijiangshuo added for yassy_6g supported 20130621
