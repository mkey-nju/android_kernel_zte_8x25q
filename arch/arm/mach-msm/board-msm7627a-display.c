...
#define VIDEO_QHD_PANEL_NAME_5P0   "5p0_video_qhd_pt"
//wangminrong add --
...
//wangminrong --
//wangminrong ++ 
#if  defined(CONFIG_PROJECT_P825F02) || defined(CONFIG_PROJECT_P865F04) || defined(CONFIG_PROJECT_P865F05)
	if (!strncmp(name, VIDEO_FWVGA_PANEL_NAME,strnlen(VIDEO_FWVGA_PANEL_NAME,
					PANEL_NAME_MAX_LEN)))
				return 0;
#elif   defined(CONFIG_PROJECT_P865G01)
	if (!strncmp(name, VIDEO_QHD_PANEL_NAME_5P0,strnlen(VIDEO_QHD_PANEL_NAME_5P0,
					PANEL_NAME_MAX_LEN)))
				return 0;
...
#define GPIO_LCDC_BRDG_RESET_N	78
#elif defined(CONFIG_PROJECT_P865G01)
#define GPIO_LCD_BACKLIGHT_EN	96
#define GPIO_LCDC_BRDG_RESET_N	78
#else
...
#if defined ( CONFIG_PROJECT_P825F02 )||defined(CONFIG_PROJECT_P825V20)            
	{ .supply = "rfrx1",   .min_uV = 2850000, .max_uV = 2850000 },
	//{ .supply = "gp2",   .min_uV = 2850000, .max_uV = 2850000 },
#elif defined(CONFIG_PROJECT_P865F04) || defined(CONFIG_PROJECT_P865F05)|| defined(CONFIG_PROJECT_P865G01) 
    { .supply = "gp2",   .min_uV = 2850000, .max_uV = 2850000 },
#else
	//{ .supply = "gp2",   .min_uV = 2850000, .max_uV = 2850000 },
	//{ .supply = "msme1", .min_uV = 1800000, .max_uV = 1800000 },
...
void __init msm_fb_add_devices(void)
{
	...
	if (machine_is_msm7627a_qrd1())
		...
		//if (disable_splash)  //wangminrong modify 2013.1.17
			mdp_pdata.cont_splash_enabled = 0x1; //wangminrong modify 2013.1.17
