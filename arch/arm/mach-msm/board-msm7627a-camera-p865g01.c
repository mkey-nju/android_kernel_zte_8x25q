...
//P865G01  AVDD VCM_AVDD use LDO as power,IOVDD use VREG_S3,
//DVDD use LDO for HI542 and not use for T4K04
#define GPIO_CAM_2V8_AVDD_EN                 117
#define GPIO_CAM_2V8_MOTO_AVDD_EN      116
#define GPIO_CAM_1V8_DVDD_EN                 120  //yuxin add for P865G01 use hi542, 2013.02.06

#define GPIO_BACK_CAM_PWDN       23
#define GPIO_BACK_CAM_RESET      123
#define GPIO_FRONT_CAM_PWDN     85
#define GPIO_FRONT_CAM_RESET     9
...
#ifdef CONFIG_OV5647  //yuxin add for compile 2013.01.16
...
#ifdef CONFIG_T4K04
static struct gpio t4k04_cam_req_gpio[] = {
	{GPIO_CAM_2V8_AVDD_EN, GPIOF_DIR_OUT, "CAM_AVDD"},
	{GPIO_CAM_2V8_MOTO_AVDD_EN, GPIOF_DIR_OUT, "CAM_VCM_AVDD"},
	//{GPIO_BACK_CAM_PWDN,GPIOF_DIR_OUT,"BACK_CAM_PEDN"},
	{GPIO_BACK_CAM_RESET,GPIOF_DIR_OUT,"BACK_CAM_RESET"},
       
};

static struct msm_gpio_set_tbl t4k04_cam_gpio_set_tbl[] = {
	{GPIO_CAM_2V8_AVDD_EN, GPIOF_OUT_INIT_HIGH, 2000},
	{GPIO_CAM_2V8_MOTO_AVDD_EN, GPIOF_OUT_INIT_HIGH, 2000},
	{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_LOW, 1000},
	{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_HIGH, 1000},
};

static struct msm_camera_gpio_conf gpio_conf_t4k04 = {
	.cam_gpio_req_tbl = t4k04_cam_req_gpio,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(t4k04_cam_req_gpio),
	.cam_gpio_set_tbl = t4k04_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(t4k04_cam_gpio_set_tbl),
	.camera_off_table = camera_off_gpio_table,
	.camera_on_table = camera_on_gpio_table,
	.gpio_no_mux = 1,
};
...
static struct gpio hi542_cam_req_gpio_tbl[] = {
    {GPIO_CAM_2V8_AVDD_EN,GPIOF_DIR_OUT,"CAM_AVDD"},
    {GPIO_CAM_2V8_MOTO_AVDD_EN,GPIOF_DIR_OUT,"CAM_AF_AVDD"},
    {GPIO_CAM_1V8_DVDD_EN,GPIOF_DIR_OUT,"HI542_DVDD"},
    {GPIO_BACK_CAM_PWDN, GPIOF_DIR_OUT, "HI542_PWDN"},
    {GPIO_BACK_CAM_RESET,GPIOF_DIR_OUT,"HI542_RESET"},
};

static struct msm_gpio_set_tbl hi542_cam_gpio_set_tbl[] = {
	{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_LOW, 1000},
	{GPIO_BACK_CAM_PWDN, GPIOF_OUT_INIT_LOW, 1000}, //hi542 active low
	{GPIO_CAM_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,2000},
	{GPIO_CAM_2V8_MOTO_AVDD_EN,GPIOF_OUT_INIT_HIGH,2000},
	{GPIO_CAM_1V8_DVDD_EN,GPIOF_OUT_INIT_HIGH,2000},
...
#ifdef CONFIG_AR0542
static struct gpio ar0542_cam_req_gpio_tbl[] = {
    {GPIO_CAM_1V8_DVDD_EN,GPIOF_DIR_OUT,"AR0542_DVDD"},
    {GPIO_CAM_2V8_AVDD_EN,GPIOF_DIR_OUT,"CAM_AVDD"},
    {GPIO_CAM_2V8_MOTO_AVDD_EN,GPIOF_DIR_OUT,"CAM_AF_AVDD"},
    {GPIO_BACK_CAM_PWDN, GPIOF_DIR_OUT, "AR0542_PWDN"},
    {GPIO_BACK_CAM_RESET,GPIOF_DIR_OUT,"AR0542_RESET"},
};

static struct msm_gpio_set_tbl ar0542_cam_gpio_set_tbl[] = {
	{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_LOW, 1000},
	{GPIO_BACK_CAM_PWDN, GPIOF_OUT_INIT_LOW, 1000}, 
	{GPIO_CAM_1V8_DVDD_EN,GPIOF_OUT_INIT_HIGH,10000},
	{GPIO_CAM_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,2000},
	{GPIO_CAM_2V8_MOTO_AVDD_EN,GPIOF_OUT_INIT_HIGH,2000},
	//move this to ar0542_sensor_power_up( ) in ar0542_v4l2.c
	//{GPIO_BACK_CAM_PWDN, GPIOF_OUT_INIT_HIGH, 5000},
	//{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_HIGH, 5000},
...
static struct msm_camera_gpio_conf gpio_conf_ar0542 = {
	.cam_gpio_req_tbl = ar0542_cam_req_gpio_tbl,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(ar0542_cam_req_gpio_tbl),
	.cam_gpio_set_tbl = ar0542_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(ar0542_cam_gpio_set_tbl),
	.camera_off_table = camera_off_gpio_table,
	.camera_on_table = camera_on_gpio_table,
	.gpio_no_mux = 1,
};
...
static struct msm_gpio_set_tbl sp0a28_cam_gpio_set_tbl[] = {
	...
	{GPIO_CAM_2V8_AVDD_EN, GPIOF_OUT_INIT_HIGH,3000},	
...
#if 0 //yuxin del for compile 2013.01.17
...
#ifdef CONFIG_S5K4E1 //yuxin move here for compile 2012.01.17
...
#define VFE_CAMIF_TIMER1_GPIO 48
#define VFE_CAMIF_TIMER2_GPIO 34
...
#ifdef CONFIG_FLASH_LM3642
static struct msm_camera_sensor_flash_data flash_t4k04 = {
	.flash_type	= MSM_CAMERA_FLASH_LED,
	.flash_src	= &msm_flash_src,
};
#else
...
static struct i2c_board_info t4k04_actuator_i2c_info = {
           I2C_BOARD_INFO("msm_actuator", 0x18),
 };

static struct msm_actuator_info t4k04_actuator_info = {
  .board_info     = &t4k04_actuator_i2c_info,
...
static struct msm_camera_sensor_platform_info sensor_board_info_t4k04 = {
	.mount_angle	= 90,
	//.cam_vreg = msm_cam_vreg,
	//.num_vreg = ARRAY_SIZE(msm_cam_vreg),
	.gpio_conf = &gpio_conf_t4k04,
};

static struct msm_camera_sensor_info msm_camera_sensor_t4k04_data = {
	.sensor_name    = "t4k04",
	.sensor_reset_enable = 1,
	.sensor_reset           = GPIO_BACK_CAM_RESET,
       .sensor_pwd             = GPIO_BACK_CAM_PWDN,
	.pdata                  = &msm_camera_device_data_csi1[0],
	.flash_data             = &flash_t4k04,
	.sensor_platform_info   = &sensor_board_info_t4k04,
	.csi_if                 = 1,
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = BAYER_SENSOR,
	.actuator_info = &t4k04_actuator_info,
...
static struct msm_camera_sensor_platform_info sensor_board_info_hi542 = {
	.mount_angle	= 90,  //270  yuxin modify 2013.02.18
	//.cam_vreg = msm_cam_vreg,
	//.num_vreg = ARRAY_SIZE(msm_cam_vreg),
...
static struct msm_camera_sensor_info msm_camera_sensor_hi542_data = {
	...
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = BAYER_SENSOR,
	.actuator_info = &hi542_actuator_info,
};
#endif
...
#ifdef CONFIG_AR0542
static struct i2c_board_info ar0542_actuator_i2c_info = {
	I2C_BOARD_INFO("msm_actuator", 0x18),
};

static struct msm_actuator_info ar0542_actuator_info = {
	.board_info     = &ar0542_actuator_i2c_info,
	.cam_name   = MSM_ACTUATOR_MAIN_CAM_1,// the same with the cam_name in af_main_cam_*.h(vendor),yuxin modify 
	.bus_id         = MSM_GSBI0_QUP_I2C_BUS_ID,
	.vcm_pwd        = 0,
	.vcm_enable     = 0,
...
static struct msm_camera_sensor_info msm_camera_sensor_ar0542_data = {
	...
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = BAYER_SENSOR,
	.actuator_info = &ar0542_actuator_info,
};
#endif
...
static struct msm_camera_sensor_platform_info sensor_board_info_sp0a28 = {
	.mount_angle	= 270,	//90  yuxin modify 2013.02.18
	//.cam_vreg = msm_cam_vreg,	
	//.num_vreg = ARRAY_SIZE(msm_cam_vreg),	
...
#endif
//其实这里不需要加代码，如果前面的sensor信息已经写全

#ifdef CONFIG_T4K04
             sensor_board_info_t4k04.cam_vreg = NULL;  
		sensor_board_info_t4k04.num_vreg = 0;
#endif


#ifdef CONFIG_SP0A28
		sensor_board_info_sp0a28.cam_vreg = NULL;  
		sensor_board_info_sp0a28.num_vreg = 0;
#endif
...
#ifdef CONFIG_AR0542
             sensor_board_info_ar0542.cam_vreg = NULL;  
		sensor_board_info_ar0542.num_vreg = 0;
#endif
...
#ifdef CONFIG_T4K04
	{
		I2C_BOARD_INFO("t4k04", 0x6c >> 1),
		.platform_data = &msm_camera_sensor_t4k04_data,
	},
#endif
...
//#ifdef CONFIG_MSM_CAMERA_FLASH
#if 0  //yuxin del quualcomm org code for compile 2013.01.16
static struct msm_camera_sensor_flash_src msm_flash_src = {
	.flash_sr_type = MSM_CAMERA_FLASH_SRC_EXT,
	._fsrc.ext_driver_src.led_en = GPIO_CAM_GP_LED_EN1,
	._fsrc.ext_driver_src.led_flash_en = GPIO_CAM_GP_LED_EN2,
...
#if defined (CONFIG_PROJECT_P865G01)
      rc = gpio_tlmm_config(GPIO_CFG(GPIO_CAM_1V8_DVDD_EN,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	if (rc < 0) {
		printk("%s:unable to enable GPIO_CAM_1V8_DVDD_EN gpio for main camera!\n",
			 __func__);
	}

      rc = gpio_tlmm_config(GPIO_CFG(GPIO_CAM_2V8_AVDD_EN,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	if (rc < 0) {
		printk("%s:unable to enable GPIO_CAM_2V8_AVDD_EN gpio for main camera!\n",
			 __func__);
	}

	
	 rc = gpio_tlmm_config(GPIO_CFG(GPIO_CAM_2V8_MOTO_AVDD_EN,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	if (rc < 0) {
		printk("%s:unable to enable GPIO_CAM_2V8_MOTO_AVDD_EN gpio for main camera!\n",
			 __func__);
	}
       rc = gpio_tlmm_config(GPIO_CFG(GPIO_BACK_CAM_PWDN,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	if (rc < 0) {
		printk("%s:unable to enable GPIO_BACK_CAM_PWDN gpio for main camera!\n",
			 __func__);
	}

	 rc = gpio_tlmm_config(GPIO_CFG(GPIO_BACK_CAM_RESET,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	if (rc < 0) {
		printk("%s:unable to enable GPIO_BACK_CAM_RESET gpio for main camera!\n",
			 __func__);
	}

	 rc = gpio_tlmm_config(GPIO_CFG(GPIO_FRONT_CAM_PWDN,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	if (rc < 0) {
		printk("%s:unable to enable GPIO_FRONT_CAM_PWDN gpio for FRONT camera!\n",
			 __func__);
	}

 	rc = gpio_tlmm_config(GPIO_CFG(GPIO_FRONT_CAM_RESET,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	if (rc < 0) {
		printk("%s:unable to enable GPIO_FRONT_CAM_RESET gpio for FRONT camera!\n",
			 __func__);
	}
